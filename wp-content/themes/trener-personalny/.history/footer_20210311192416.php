...
<footer class="footer" role="contentinfo">
    <div class="container__custo">
        <div class="row">
            <div class="col-md-4 footer__col footer__col-left"><span>© 2021 PixTricks Studio</span></div>
            <div class="col-md-4 footer__col footer__col-mid"><img class="footer__logo" src="<?php echo get_template_directory_uri(); ?>/img/logo-pixtricks-revers.png" alt=""></div>
            <div class="col-md-4 footer__col footer__col-right"><?php html5blank_nav(); ?></div>
        </div>
    </div>
</footer><!-- #colophon -->
